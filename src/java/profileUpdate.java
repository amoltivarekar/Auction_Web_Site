...
public class profileUpdate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            String sn=request.getParameter("sfullname");
            String se=request.getParameter("semail");
            String sa=request.getParameter("saddress");
            String sp=request.getParameter("sphoneno");
            String su=request.getParameter("susername");
            String spass=request.getParameter("spassword");
            
            
            String sellerName=request.getParameter("user");
            ...
            if(!(sn.isEmpty() ||  se.isEmpty() || sa.isEmpty() || sp.isEmpty() || su.isEmpty() || spass.isEmpty()))
            {
                ...
                PreparedStatement pst = con.prepareStatement("update sellerSelfInfo set sname=?,semail=?,saddress=?,sphoneno=?,susername=?,spassword=? where sname='"+sellerName+"'");
                pst.setString(1,sn);
                pst.setString(2,se);
                pst.setString(3,sa);
                pst.setString(4,sp);
