...
<%
    ...
    sur = ses.getAttribute("biddername").toString();
    
    pst = con.prepareStatement("select bname,bemail,baddress,bphoneno,busername,bpassword from BidderSelfInfo where bname='"+sur+"'");
       
     
    ses.setAttribute("sname", sur);
    }
    catch(Exception e)
    {
...
<html>
    <head>
        <title>bidder update profile</title>
        <meta charset="UTF-8">
 ...
 <a href="bidding.jsp" style="color:rgb(90,150,200); font-weight: bold;">BIDDING</a>
	...
	<div class="container">
        ...
        <div class="userbar">
            ...
            <a href="bidderupdateprofile.jsp?sname=<%=sur%>"><%=sur%></a>
            <a href="BidderProfile.jsp" >History</a>
            <a href="bidderlogout" class="tag ">Logout</a>
        </div>
	...
	<div class="contact-main">
	   <div class="container">
			<div class="contact-top">
				<h3>BIDDER</h3>
				<p>Bidder should fill the below information and Edit the account</p>
			</div>
			<div class="contact-bottom">
			  <form action="bidderprofileupdate?user=<%=sur%>" method="post" name="myForm" onSubmit="return validateForm()" >
				<div class="col-md-7 contact-left">
                             <% rs =pst.executeQuery();
                                while(rs.next()){%>       
		            <p>Name</p>
		             <input type="text" value="<% out.print(rs.getString(1)); %>" name="bfullname" onkeypress="return validateFm(event)" style="color:#0B758A;" readonly/>
		            <p>E-mail</p> 
		             <input type="text" value="<% out.print(rs.getString(2)); %>" name="bemail" style="color:#0B758A;"/>
		            <p>Address</p>
		             <input type="text" value="<% out.print(rs.getString(3)); %>" name="baddress" style="color:#0B758A;"/>
		            <p>Phone No.</p>
		             <input type="text" value="<% out.print(rs.getString(4)); %>" name="bphoneno" onkeypress="return validatephno(event)" style="color:#0B758A;"/>
                            <p>UserName</p>
		             <input type="text" value="<% out.print(rs.getString(5)); %>" name="busername" style="color:#0B758A;"/>
                            <p>Password</p>
		             <input type="password" value="<% out.print(rs.getString(6)); %>" name="bpassword" style="color:#0B758A;"/>  
                            <p>Confirm Password</p>
		             <input type="password" value="<% out.print(rs.getString(6)); %>" name="bcpassword" style="color:#0B758A;"/> 
                                </div>
				<div class="col-md-5 contact-right">
					<p>Photo</p>
                                        <img src="images/Untitled.png" width="200px" height="200px">
