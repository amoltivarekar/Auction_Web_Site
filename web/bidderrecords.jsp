...
<%
    try
    {
        ...
        pst=con.prepareStatement("select bname,bemail,baddress,bphoneno from BidderSelfInfo");
        rs=pst.executeQuery();
...
<html>
    <head>
        <title>Bidder Records Page</title>
        <meta charset="UTF-8">
	...
	<div class="container">
        ...
        <div class="userbar">
           <img src="images/t1.jpg" />
            ...
            <a href="bidderrecords.jsp" class="tag active">Bidder Records</a>
                 ...
                 <table width="90%" class="table-curved">
                    <thead>
                      ...
                      <tr>
                           ...
                           <td>
                                <input type="submit" value="Delete" onclick="window.location='deletebidderrecord?bidderName=<%=rs.getString(1)%>'" style="border-radius: 5px; background: rgb(94,200,150); color:white; padding:5px 15px 5px 15px;">
                           </td>
                      </tr>
                       <%}%>  
                 </table>
