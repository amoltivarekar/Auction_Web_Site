...
<%
    try
    {
        ...
        pst=con.prepareStatement("select name,address,emailid,phoneno from admin");
        rs=pst.executeQuery();
        rs.next();
    }
    catch(Exception e)
	...
	<div class="container">
        ...
        <div class="userbar">
           <img src="images/t1.jpg" />
            ...
            <a href="AdminProfilepage.jsp" class="tag active">profile</a>
            ...
            <div class="admininfo">
                 <img src="images/t1.jpg" alt="admin photo" width="200px" height="200px" style="float:left;">
                 <table>
