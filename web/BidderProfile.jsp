...
<%
    try
    {
        ...
        pst = con.prepareStatement("select bpname,bpprice,bpdate,bptime,bpdec,bpsname,bpsphone from biddingproduct where bpbname='"+sur+"'");
    }
    catch(Exception e)
    {
        out.print("hello : "+e);
...
<html>
    <head>
        <title>Bidder Profile page</title>
        <meta charset="UTF-8">
...
<script type="text/javascript" src="js/easing.js"></script>
	...
	<div class="container">
        ...
        <div class="userbar">
            ...
            <a href="BidderProfile.jsp" class="tag active">History</a>
	...
	<ul>
		...
		<li>
			<div>
				<img src="images/gallery-1446741537-screen-shot-2015-11-05-at-111638-am-copy.jpg" >
				<div class="user">
                                        <img src="images/t2.jpg" alt=""class="seller img"/>
					<p><% out.print(rs.getString(6)); %><br><% out.print(rs.getString(7)); %><br>
				...
				<div class="prod" class="flt">
					...
					<a>Bidding date :</a><% out.print(rs.getString(3)); %><br>
					<a>Bidding Time :</a><% out.print(rs.getString(4)); %><br>
					<a>Bidding Starting Rate : </a><% out.print(rs.getInt(2)); %><br><br>
					<% out.print(rs.getString(5)); %></p>
