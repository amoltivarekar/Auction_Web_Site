...
<%
    ...
    pst = con.prepareStatement("select sname,semail,saddress,sphoneno,susername,spassword from SellerSelfInfo where sname='"+sur+"'");
...
<html>
    <head>
        <title>seller profile update page</title>
        <meta charset="UTF-8">
	...
	<div class="contact-main">
	   <div class="container">
			<div class="contact-top">
				<h3>SELLER </h3>
				<p>Seller should fill the below information and Edit the account</p>
			</div>
			<div class="contact-bottom">
			  <form action="profileUpdate?user=<%=sur%>" method="post" name="myForm" onSubmit="return validateForm()" >
				<div class="col-md-7 contact-left">
                             <% rs =pst.executeQuery();
                                while(rs.next()){%>       
		            <p>Name</p>
		             <input type="text" value="<% out.print(rs.getString(1)); %>" name="sfullname" onkeypress="return validateFm(event)" style="color:#0B758A;" readonly/>
		            <p>E-mail</p> 
		             <input type="text" value="<% out.print(rs.getString(2)); %>" name="semail" style="color:#0B758A;"/>
		            <p>Address</p>
		             <input type="text" value="<% out.print(rs.getString(3)); %>" name="saddress" style="color:#0B758A;"/>
		            <p>Phone No.</p>
		             <input type="text" value="<% out.print(rs.getString(4)); %>" name="sphoneno" onkeypress="return validatephno(event)" style="color:#0B758A;"/>
                            <p>UserName</p>
		             <input type="text" value="<% out.print(rs.getString(5)); %>" name="susername" style="color:#0B758A;"/>
                            <p>Password</p>
		             <input type="password" value="<% out.print(rs.getString(6)); %>" name="spassword" style="color:#0B758A;"/>  
                            <p>Confirm Password</p>
		             <input type="password" value="<% out.print(rs.getString(6)); %>" name="scpassword" style="color:#0B758A;"/> 
                                </div>
