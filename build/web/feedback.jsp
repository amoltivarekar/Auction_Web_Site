	...
	<div class="container">
        ...
        <div class="userbar">
           <img src="images/t1.jpg" />
            ...
            <a href="feedback.jsp" class="tag active">Feedback</a>
                 ...
                 <table width="90%" class="table-curved">
                    <thead>
                      ...
                      <tr>  
                           ...
                           <td>
                                <input type="submit" value="Delete" onclick="window.location='deletefeedback?feedbackName=<%=rs.getString(1)%>'" style="border-radius: 5px; background: rgb(94,200,150); color:white; padding:5px 15px 5px 15px; margin-right: 20px;">
                           </td>
                      </tr>
                       <%}%>  
                 </table>
