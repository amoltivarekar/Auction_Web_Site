 ...
 <a href="bidding.jsp" style="color:rgb(90,150,200); font-weight: bold;">BIDDING</a>
	...
	<div class="container">
        ...
        <div class="userbar">
            ...
            <a href="sellerlogin" class="tag1 active">Product Registration Form</a>
	...
	<div class="contact-main">
	   <div class="container">
			<div class="contact-top">
				<h3>SELLER </h3>
				<p>Seller should fill the below information of product for Auction</p>
			</div>
			<div class="contact-bottom">
			  <form action="SellerProInfo" method="post">
				<div class="col-md-7 contact-left">
		            <p>Name Of Product</p>
		             <input type="text" value="" name="productname" />
		            <p>Price Of Product</p> 
		             <input type="text" value="" name="productprice" onkeypress="return validatephno(event)"/>
                             <p>Type</p>
                             <select name="productType" class="selectitem" required>
                                  <option>All</option>
                             ...
                             <p>Date</p>
		             <input type="date" value="" name="productdate" />
                            <p>Time</p>
		             <input type="time" value="" name="producttime" />
                            <p>Description</p>
                             <textarea name="pdec" ></textarea>
                                </div>
