...
<%
    try
    {
        ...
        pst=con.prepareStatement("select pname,pprice,pdate,ptime,pdec from SellerProdInfo");
        rs=pst.executeQuery();
	...
	<div class="container">
        ...
        <div class="userbar">
           <img src="images/t1.jpg" />
            ...
            <a href="allproducts.jsp" class="tag active">All Products</a>
                    ...
                    <thead>
                      ...
                      <tr>
                           <td align="center" valign="middle">
                                <img src="images/blog1.jpg" width="50px" height="50px">
                           </td>
                           <td align="center" valign="middle">
                                <%=rs.getString(1)%>
                           </td>
                           ...
                           <td>
                                <input type="submit" value="Delete" onclick="window.location='deleteproduct?productName=<%=rs.getString(1)%>'" style="border-radius: 5px; background: rgb(94,200,150); color:white; padding:5px 15px 5px 15px; margin-right: 20px;">
                           </td>
                      </tr>
                       <%}%>  
                 </table>
